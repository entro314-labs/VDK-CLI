...
try {
  const { detectIDEs, detectSpecificJetBrainsIDEs, IDE_CONFIGURATIONS } =
    await import('./src/shared/ide-configuration.js');
  ...
  console.log(
    `✅ JetBrains detection function works, found ${jetbrainsIDEs.length} specific IDE(s)`
  );
} catch (error) {
