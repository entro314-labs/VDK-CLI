...
describe('IDE Integrations', () => {
  ...
  describe('Claude Code CLI Integration', () => {
    it('should load claude code cli integration', async () => {
      const { ClaudeCodeCLIIntegration } =
        await import('../src/integrations/claude-code-integration.js');
  ...
  describe('VS Code Variants Integration', () => {
    it('should load vscode variants integration', async () => {
      const { VSCodeInsidersIntegration, VSCodiumIntegration } =
        await import('../src/integrations/vscode-variants-integration.js');
    ...
    it('should create vscode insiders integration instance', async () => {
      const { VSCodeInsidersIntegration } =
        await import('../src/integrations/vscode-variants-integration.js');
  ...
  describe('Generic AI Integration', () => {
    it('should load generic ai integration', async () => {
      const { GenericAIIntegration } =
        await import('../src/integrations/generic-ai-integration.js');
  ...
  describe('Integration Manager Discovery', () => {
    it('should discover all new integrations', async () => {
      ...
      for (const expectedModule of expectedModules) {
        expect(allModules.some(module => module.includes(expectedModule.replace('./', '')))).toBe(
          true
        );
      }
    });
