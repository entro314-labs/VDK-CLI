...
3. Handle errors gracefully`;
    ...
    it('should handle file reading errors gracefully', async () => {
      ...
      expect(consoleSpy.warn).toHaveBeenCalledWith(
        expect.stringContaining('Could not process problematic.md')
      );
    });
  });
  ...
  describe('Project Analysis', () => {
    ...
    it('should handle inaccessible project directory', async () => {
      ...
      expect(context.primaryFramework).toBe('generic');
      expect(consoleSpy.warn).toHaveBeenCalledWith(
        expect.stringContaining('Project directory inaccessible')
      );
    });
  });
  ...
  describe('Migration Preview', () => {
    ...
    it('should create migration preview successfully', async () => {
      ...
      const preview = await autoMigrator.createMigrationPreview(
        mockDetectedRules,
        mockProjectContext
      );
  ...
  describe('Rule Adaptation', () => {
    ...
    it('should adapt rules to project context successfully', async () => {
      ...
      const adaptedRules = await autoMigrator.adaptRulesToProject(
        mockDetectedRules,
        mockProjectContext,
        {
  ...
  describe('Complete Migration Workflow', () => {
    beforeEach(() => {
      ...
      fs.readFile
        .mockResolvedValueOnce('Cursor rules content')
    ...
    it('should handle cleanup failures gracefully', async () => {
      ...
      expect(consoleSpy.warn).toHaveBeenCalledWith(
        expect.stringContaining('Could not clean import directory')
      );
    });
  });
  ...
  describe('Suggestions Generation', () => {
    it('should identify publish-worthy rules', () => {
      ...
      expect(suggestions.nextSteps).toContain(
        'Consider sharing your adapted rules with the community'
      );
    });
    ...
    it('should suggest improvements for low quality rules', () => {
      ...
      expect(suggestions.improvements).toContain(
        'Some rules could benefit from additional customization'
      );
    });
  ...
  describe('UI Helper Methods', () => {
    it('should show import instructions when no rules found', () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(
        expect.stringContaining('To migrate existing AI rules:')
      );
    ...
    it('should display completion message', () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(
        expect.stringContaining('Deployed to: claude-code, cursor, windsurf')
      );
    });
