...
describe('Command Architecture - Comprehensive Tests', () => {
  ...
  describe('BaseCommand Functionality', () => {
    ...
    it('should validate required options', async () => {
      ...
      await command.validateOptions({ param1: 'value1' }, { required: ['param1', 'param2'] });

      expect(exitSpy).toHaveBeenCalledWith(
        expect.stringContaining('Missing required option: --param2')
      );
  ...
  describe('Migration Commands', () => {
    it('should load UnifiedMigrateCommand', async () => {
      const { UnifiedMigrateCommand } =
        await import('../src/commands/migration/UnifiedMigrateCommand.js');
    ...
    it('should load SchemaMigrateCommand', async () => {
      const { SchemaMigrateCommand } =
        await import('../src/commands/migration/SchemaMigrateCommand.js');
