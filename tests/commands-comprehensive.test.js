...
describe('Command Architecture - Comprehensive Tests', () => {
  ...
  describe('BaseCommand Functionality', () => {
    ...
    it('should validate required options', async () => {
      ...
      expect(exitSpy).toHaveBeenCalledWith(expect.stringContaining('Missing required options: param2'))
    ...
    it('should enforce abstract method implementation', async () => {
      ...
      await expect(command.execute({})).rejects.toThrow('Command test must implement execute() method')
    })
  })
  ...
  describe('Core Commands', () => {
    ...
    it('should load ScanCommand', async () => {
      ...
      expect(command.description).toContain('Re-analyze project')
      expect(typeof command.configureOptions).toBe('function')
      expect(typeof command.execute).toBe('function')
    })
    ...
    it('should load StatusCommand', async () => {
      ...
      expect(command.description).toContain('Check the status')
      expect(typeof command.configureOptions).toBe('function')
      expect(typeof command.execute).toBe('function')
    })
  ...
  describe('Migration Commands', () => {
    it('should load UnifiedMigrateCommand', async () => {
      const { UnifiedMigrateCommand } = await import('../src/commands/migration/UnifiedMigrateCommand.js')

      const command = new UnifiedMigrateCommand()
  ...
  describe('Hub Commands', () => {
    it('should handle hub status via StatusCommand', async () => {
      const { StatusCommand } = await import('../src/commands/core/StatusCommand.js')

      const command = new StatusCommand()

      expect(command.name).toBe('status')
      expect(command.description).toContain('Hub')
      expect(typeof command.configureOptions).toBe('function')
      expect(typeof command.execute).toBe('function')
    })
  ...
  describe('CLI Program Factory', () => {
    ...
    it('should handle command execution errors gracefully', async () => {
      ...
      expect(exitSpy).toHaveBeenCalledWith(expect.stringContaining('Test error command failed'), expect.any(Error))
