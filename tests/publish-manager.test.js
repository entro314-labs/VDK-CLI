  ...
  describe('Publishing Workflows', () => {
    ...
    describe('GitHub Publishing', () => {
      ...
      it('should handle GitHub PR creation failures', async () => {
        mockFormatConverter.convertToUniversal.mockResolvedValue({ content: 'converted' });
        mockGitHubClient.createCommunityBlueprintPR.mockRejectedValue(
    ...
    describe('Main Publish Method', () => {
      ...
      it('should handle validation failures', async () => {
        ...
        await expect(publishManager.publish(mockRulePath)).rejects.toThrow(
...
# Content`;
  ...
  describe('UI Helper Methods', () => {
    ...
    it('should generate publishing recommendations', () => {
      ...
      const recommendations = publishManager.generatePublishingRecommendations(
      ...
      expect(recommendations).toContain(
        'Rule content is quite brief - consider adding more detail'
      );
      expect(recommendations).toContain(
        'Consider adding technology-specific context for better adaptation'
      );
    });
  });
});
